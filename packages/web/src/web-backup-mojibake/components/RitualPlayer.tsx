...
export const RITUAL_PHRASES = [
  "Mente San, Corpo Run.",
  "É treino, ritmo é missão.",
  "Constância em movimento.",
  "Resultado vem de quem vai além.",
  "Não é sobre pace. É sobre entrega.",
  "Não tem truque. Tem processo.",
  "Todo treino é um progresso.",
];
    ...
    <div style={{
      ...
      <div style={{ display:"flex",alignItems:"center",gap:14,marginBottom:16 }}>
        ...
        <div style={{ flex:1,minWidth:0 }}>
          ...
          <p style={{ fontSize:"0.68rem",color:"var(--terra, #C4622D)",fontWeight:600 }}>Ritual de Ativação</p>
          {/* track dots */}
