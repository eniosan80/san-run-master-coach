...
/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
   FORCA_CATEGORIES â€” mantido para compatibilidade
...
export const FORCA_CATEGORIES = [
  {
    ...
    subtitle: "Fortalecer mÃºsculos do passada",
    icon: null,
    color: "#C4622D",
  ...
  },
  {
    ...
    subtitle: "Melhorar movimento e eficiÃªncia",
    icon: null,
    color: "#5a8fa5",
  ...
  },
  {
    ...
    subtitle: "TÃ©cnica e mecÃ¢nica da passada",
    icon: null,
    color: "#7a6a5a",
...
export default function ForcaPage() {
  ...
  /* â”€â”€â”€ SEM plano configurado â”€â”€â”€ */
  if (!plan || !profile) {
    return (
      <div style={{
        minHeight: "100dvh",
        ...
        <div style={{ padding: "24px 24px 0" }}>
          ...
          <p style={{ fontSize: "0.78rem", color: "#A0A0A0", margin: 0, lineHeight: 1.5 }}>
            ForÃ§a prescrita para o seu perfil. Nada genÃ©rico.
          </p>
        </div>
        ...
        <div style={{
          ...
          <h3 style={{ fontFamily: "'Waffle Soft', sans-serif", fontSize: "1.05rem", color: "#F5F0EB", fontWeight: 800, marginBottom: 10 }}>
            ForÃ§a prescrita para vocÃª
          </h3>
          <p style={{ fontSize: "0.78rem", color: "#A0A0A0", lineHeight: 1.55, marginBottom: 24 }}>
            Responda 4 perguntas e o SAN RUN monta seu plano de forÃ§a personalizado â€” exercÃ­cios certos, dias certos, no tempo certo.
          </p>

          {/* Pilares */}
          <div style={{ display: "flex", gap: 10, marginBottom: 24 }}>
            {[
              { label: "Mobilidade", desc: "Para o seu nÃ­vel" },
              { label: "ForÃ§a", desc: "Ãreas prioritÃ¡rias" },
              { label: "PrevenÃ§Ã£o", desc: "Seus desconfortos" },
            ].map(p => (
        ...
        <div style={{ padding: "0 24px" }}>
          ...
          {[
            { q: "Dias disponÃ­veis por semana", a: "Integrado ao seu calendÃ¡rio de corrida" },
            { q: "RegiÃµes de desconforto", a: "ExercÃ­cios preventivos especÃ­ficos" },
            { q: "Ãreas mais fracas", a: "Foco nos mÃºsculos prioritÃ¡rios" },
  ...
  /* â”€â”€â”€ COM plano configurado â”€â”€â”€ */
  ...
  return (
    ...
    <div style={{
      ...
      <div style={{ display: "flex", gap: 10, padding: "18px 24px 0" }}>
        {[
          { icon: <IcCheck />, val: String(plan.sessionsCompleted), label: "SessÃµes" },
          { icon: <IcClock />, val: plan.totalDuration, label: "Por sessÃ£o" },
      ...
      {isForcaDay && (
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontSize: "0.75rem", fontWeight: 800, color: "#F5F0EB", margin: "0 0 2px" }}>Hoje Ã© dia de forÃ§a</p>
            <p style={{ fontSize: "0.68rem", color: "#A0A0A0", margin: 0 }}>
              {plan.blocks.length} exercÃ­cios Â· {plan.totalDuration}
            </p>
          </div>
          <button
      ...
      {/* NÃ£o Ã© dia de forÃ§a mas tem plano */}
      {!isForcaDay && (
        <div style={{
          margin: "16px 24px 0",
          padding: "14px 16px",
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "#F5F0EB", margin: "0 0 2px" }}>
              {daysSinceSession === null
                ? "Ainda nÃ£o fez nenhuma sessÃ£o"
                : daysSinceSession === 0
                ? "SessÃ£o feita hoje"
                : `Ãšltima sessÃ£o hÃ¡ ${daysSinceSession} dia${daysSinceSession > 1 ? "s" : ""}`}
            </p>
            <p style={{ fontSize: "0.68rem", color: "#A0A0A0", margin: 0 }}>
              PrÃ³xima sessÃ£o: {plan.focusDays.map(d => DAY_LABELS[d]).join(", ")}
            </p>
          </div>
          <button
            onClick={() => navigate("/forca/sessao")}
