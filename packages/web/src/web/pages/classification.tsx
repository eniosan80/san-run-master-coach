...
const LEVEL_META = [
  null,
  { name: "Iniciante Absoluto",   color: "#7AAFC0", dim: "rgba(90,130,150,0.15)",  desc: "Primeiro contato com a corrida. Foco em adaptação e consistência." },
  { name: "Corredor Iniciante",   color: "#7AAFC0", dim: "rgba(58,95,111,0.18)",   desc: "Base em construção. Aprende a respeitar o corpo e o processo." },
  { name: "Intermediário",        color: "#C4A032", dim: "rgba(120,90,40,0.15)",   desc: "Consistência estabelecida. Começa a explorar distâncias e ritmos." },
  { name: "Avançado",             color: "#C4622D", dim: "rgba(196,98,45,0.14)",   desc: "Busca performance. Treino estruturado com objetivos específicos." },
  { name: "Avançado Performance", color: "#C4622D", dim: "rgba(196,98,45,0.18)",   desc: "Alto desempenho. Planeja para provas e monitora cada variável." },
];
  ...
  return (
    <div className="shell">
      <div className="screen">
        ...
        <div style={{ padding: "32px 24px 24px", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <div className="anim-up d2">
            <p className="t-caption" style={{ color: "var(--muted)", marginBottom: 6 }}>SEU NÍVEL ATUAL</p>
        ...
        <div style={{ padding: "0 24px 28px", display: "flex", flexDirection: "column", gap: 10, position: "relative", zIndex: 1 }}>
          ...
          <div className="card anim-up d3">
            <p className="t-caption" style={{ color: "var(--terra)", marginBottom: 10 }}>Por que esse nível?</p>
          ...
          <div className="card-terra anim-up d4">
            <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
              ...
              <div>
                <p className="t-caption" style={{ color: "var(--terra-lite)", marginBottom: 6 }}>Próximo foco</p>
      ...
      <div className="bottom-bar anim-up d5">
        <SanBtn label="Próximo: escala RPE" onClick={() => nav("/rpe")} />
