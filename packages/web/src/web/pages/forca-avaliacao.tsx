...
const WEAK_OPTIONS = [
  ...
  { id: "pernas",       label: "Pernas / Quadríceps"},
  { id: "panturrilhas", label: "Panturrilhas"        },
  { id: "outra_weak",   label: "Outra"              },
];

const MOBILITY_OPTIONS = [
  { id: "travado", label: "Muito travado", desc: "Difícil agachar fundo, quadril rígido" },
  { id: "pouca", label: "Pouca mobilidade", desc: "Consigo fazer, mas sinto limitação" },
  { id: "normal", label: "Normal", desc: "Movimento razoável, sem grandes problemas" },
...
export default function ForcaAvaliacaoPage() {
  ...
  function toggleMulti(field: "discomfort" | "weakAreas", id: string) {
    setAnswers(prev => {
      ...
      // Lógica exclusiva: "nenhuma"/"nao_sei" limpa os outros
  ...
  const stepTitles: Record<Step, string> = {
    1: "Quantos dias por semana você consegue dedicar à força?",
    2: "Você sente desconforto em alguma dessas regiões?",
    3: "Qual área você percebe como mais fraca?",
    4: "Como está sua mobilidade geral?",
  };

  const stepSubs: Record<Step, string> = {
    1: "Além dos dias de corrida",
