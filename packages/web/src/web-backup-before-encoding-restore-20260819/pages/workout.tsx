...
/** Extrai um "preview r�pido" tipo "FARTLEK: 10 x 1'/2'" a partir dos blocks */
function buildQuickPreview(blocks: WorkoutBlock[], title: string): string {
  // encontra o bloco principal de s�rie
...
function blocksToSections(blocks: WorkoutBlock[]): BlockSection[] {
  return blocks.map(b => {
    ...
    return {
      ...
      restRpe: b.restRpe ?? 2,
      restLabel: b.restLabel || "Recupera��o",
    };
  });
}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: "0.6rem", fontWeight: 800, letterSpacing: "0.14em", color: accent, textTransform: "uppercase" }}>BLOCO CONT�NUO</span>
        <span style={{ fontSize: "0.75rem", fontWeight: 700, color: accent }}>{fmtMin(s.durationMin)}</span>
      </div>
      <div style={{ padding: "12px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <span style={{ fontSize: "0.85rem", fontWeight: 600, color: "var(--offwhite)" }}>{s.label}</span>
        ...
        <div style={{ padding: "0 20px", display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div className="anim-up d1" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
            <div className="card" style={{ textAlign: "center", padding: "14px 6px", display: "flex", flexDirection: "column", alignItems: "center", gap: 5 }}>
              ...
              <p style={{ fontSize: "0.58rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--muted)" }}>Dura��o</p>
            </div>
            <div style={{
            ...
            <div className="card" style={{ textAlign: "center", padding: "14px 6px", display: "flex", flexDirection: "column", alignItems: "center", gap: 5 }}>
              ...
              <p style={{ fontSize: "0.58rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--muted)" }}>N�vel</p>
            </div>
          </div>
          ...
          <div style={{ textAlign: "center", padding: "4px 0 20px" }}>
            <p style={{ color: "var(--muted)", fontSize: "0.75rem", fontStyle: "italic" }}>
              "Resultado vem do processo. Const�ncia em movimento."
            </p>
          </div>
        </div>
      </div>
