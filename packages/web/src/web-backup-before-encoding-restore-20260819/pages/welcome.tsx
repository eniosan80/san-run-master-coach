...
const PILLARS = [
  ...
  ), text: "Baseado em ci�ncia do esporte", color: "terra" },
  { icon: (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>
    </svg>
  ), text: "Const�ncia antes de progress�o", color: "terra" },
  { icon: (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div>
          ...
          <div className="anim-up d1">
            ...
            <p style={{
              ...
              Ci�ncia, processo e mentalidade � um treinador que entende o seu momento.
            </p>
          </div>
        </div>

        {/* ESCUDO CENTRAL � tamanho fixo, sem flex: 1 pra n�o empurrar conte�do */}
        <div style={{
