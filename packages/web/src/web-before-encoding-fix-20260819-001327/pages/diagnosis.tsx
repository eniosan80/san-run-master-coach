...
export default function DiagnosisPage() {
  ...
  const blocks = [
    ...
    { label: "INTERPRETA��O", content: diagnosis.interpretation,  cardClass: "card-terra", icon: <IconBrain />,     accent: "var(--terra)" },
    { label: "DECIS�O",       content: diagnosis.decision,        cardClass: "card",       icon: <IconTarget />,    accent: "var(--fg)"   },
  ];
      ...
      <div className="screen" style={{ paddingBottom: 0 }}>
        ...
        <div className="anim-up" style={{ marginBottom: 24 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
            ...
            <p className="d6">Diagn�stico SAN RUN</p>
          </div>
          <h2 className="d1">An�lise de {athlete.name}</h2>
        ...
        <div className="card anim-up" style={{ marginTop: 12 }}>
          <p style={{ color: "var(--muted)", fontSize: 12, lineHeight: 1.6 }}>
            ...
            Este diagn�stico � uma orienta��o baseada nas suas respostas. N�o substitui avalia��o m�dica ou de profissional de educa��o f�sica.
          </p>
        </div>
