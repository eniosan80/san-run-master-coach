...
const expOpts = [
  ...
  { v: "beginner",     label: "Estou come�ando agora", desc: "Menos de 3 meses" },
  { v: "intermediate", label: "Corro h� algum tempo",  desc: "3 meses a 2 anos" },
...
const freqOpts = [
  ...
  { v: "5+",  label: "5 ou mais por semana", sub: "Alta frequ�ncia" },
];

// Sugest�es sem "meia maratona" isolado � "prova" agora abre campos espec�ficos
const goalSuggestions = [
  "Quero correr 2 km sem parar",
  "Quero completar 5 km",
  "Quero melhorar meu tempo no 5 km",
  "Quero emagrecer correndo",
  "Quero treinar com mais consist�ncia",
  "Quero correr uma prova",
  "Outro",
];

const RACE_DISTANCES = ["5 km", "10 km", "21 km", "Outra dist�ncia"];
...
export default function OnboardingPage() {
  ...
  // Selecionar sugest�o de objetivo
  ...
  const buildGoalString = () => {
    ...
    if (form.raceMode) {
      const dist = form.raceDistance === "Outra dist�ncia" ? form.raceCustomDistance : form.raceDistance;
  ...
  const submit = async () => {
    ...
    try {
      ...
      setErr("Erro ao conectar. Verifique sua conex�o e tente novamente.");
      setLoading(false);
    }
  };
  ...
  const btnLabel = loading
    ? "Gerando sua avalia��o..."
    : step === TOTAL
      ? "Gerar avalia��o SAN RUN"
      : step === 3
        ? "Continuar"
        : "Continuar";
    ...
    <div className="shell">
        ...
        <div style={{ padding: "28px 24px 20px" }}>
          ...
          {step === 1 && (
            <div className="anim-up">
              ...
              <h1 className="t-h1" style={{ marginBottom: 8 }}>Vamos come�ar<br />pela apresenta��o</h1>
              <p className="t-body" style={{ marginBottom: 28 }}>
                Para montar seu perfil de corredor, preciso de algumas informa��es b�sicas.
              </p>
          ...
          {step === 2 && (
            <div className="anim-up">
              ...
              <p className="t-body" style={{ marginBottom: 24 }}>Sem julgamento � cada corredor come�a de um ponto diferente.</p>

              <label className="t-caption" style={{ display: "block", marginBottom: 10 }}>Sua experi�ncia com corrida</label>
              ...
              <label className="t-caption" style={{ display: "block", marginBottom: 10 }}>
                Quais dias da semana voc� pretende treinar?
              </label>
              <p style={{ fontSize: "0.78rem", color: "var(--muted)", marginBottom: 14, lineHeight: 1.5 }}>
                Seus treinos ser�o organizados nesses dias.
              </p>
              <div style={{ display: "flex", gap: 8, justifyContent: "space-between" }}>
                {[{ d: 1, label: "Seg" },{ d: 2, label: "Ter" },{ d: 3, label: "Qua" },{ d: 4, label: "Qui" },{ d: 5, label: "Sex" },{ d: 6, label: "S�b" },{ d: 0, label: "Dom" }].map(({ d, label }) => {
          ...
          {step === 3 && (
            <div className="anim-up">
              ...
              <h1 className="t-h1" style={{ marginBottom: 8 }}>Qual � o seu<br />objetivo com a corrida?</h1>
              <p className="t-body" style={{ marginBottom: 24 }}>Escolha o que mais representa o que voc� quer alcan�ar.</p>
              ...
              {form.raceMode && (
                <div style={{ marginTop: 20, display: "flex", flexDirection: "column", gap: 12 }}>
                  <label className="t-caption" style={{ display: "block", marginBottom: 4 }}>Dist�ncia da prova</label>
                  ...
                  {form.raceDistance === "Outra dist�ncia" && (
          ...
          {step === 4 && (
            <div className="anim-up">
              ...
              <h1 className="t-h1" style={{ marginBottom: 8 }}>Revis�o do<br />seu perfil</h1>
              <p className="t-body" style={{ marginBottom: 24 }}>Confirme as informa��es antes de gerar sua avalia��o.</p>

              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {[
                  { label: "Nome", value: form.name },
                  { label: "Idade", value: `${form.age} anos` },
                  { label: "Experi�ncia", value: expOpts.find(o => o.v === form.experience)?.label || form.experience },
                  { label: "Frequ�ncia atual", value: freqOpts.find(o => o.v === form.weeklyFrequency)?.label || form.weeklyFrequency },
                  {
      ...
      <div className="bottom-bar">
        <SanBtn
          ...
          disabled={!canNext()}
          loading={loading}
          loadingLabel="Gerando sua avalia��o..."
        />
      </div>
